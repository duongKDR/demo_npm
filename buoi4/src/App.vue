  ...
  <div id="home">
    <div id="login-form">
      ...
      <div id="login-body">
        ...
        <button class="login-button"  @click.prevent="login">Đăng nhập</button>
        ...
        <div style="
              ...
              padding-top: 10px;
            ">
          <span class="otherway fa fa-brands fa-facebook"><i class="fa fa-brands fa-facebook"
              style="font-size: 18px; padding-right: 5px; color: #4285F4;"></i>Facebook</span>
          <span class="otherway" @click.prevent="loginWithGoogle">

            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"  viewBox="0 0 18 18" aria-hidden="true"  style=" padding-right: 5px;">
              <title>Google</title>
